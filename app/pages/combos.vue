...
const comboEntries = computed(() => keyboardStore.comboEntries || [])
const comboCount = computed(() => keyboardStore.comboCount || 0)
    ...
    <div class="flex h-full flex-col items-center">
      <div class="w-full">
        ...
        <div v-else-if="keyboardStore.comboCount === null" class="rounded-lg bg-surface-100 p-4 text-center dark:bg-surface-800">
          <Icon name="tabler:loader-2" class="mr-2 animate-spin text-xl" />
        ...
        <div v-else class="flex flex-col items-center">
          ...
          <div class="w-full max-w-md space-y-3">
            ...
            >
              ...
              <div
                class="flex size-12 items-center justify-center rounded border-2 text-lg font-medium transition-all"
            ...
            <!-- Output Key -->
            <div
              class="flex cursor-pointer items-center justify-center gap-4 pt-2"
